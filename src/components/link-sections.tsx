        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center">
            ...
            <div className="space-y-2">
              <Link to="/products/men" className="block text-sm hover:underline">Shop Shirts</Link>
              <Link to="/products/men" className="block text-sm hover:underline">Shop Pants</Link>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-2">
              <Link to="/products/women" className="block text-sm hover:underline">Shop Apparel</Link>
              <Link to="/products/women" className="block text-sm hover:underline">Shop Accessories</Link>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-2">
              <Link to="/products/bags" className="block text-sm hover:underline">Shop Bags</Link>
              <Link to="/products/accessories" className="block text-sm hover:underline">Shop Accessories</Link>
            </div>
          </div>
        </div>
      </div>
