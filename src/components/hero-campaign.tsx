    ...
    <section className="w-full h-96 bg-gradient-to-r from-gray-800 to-gray-700 flex items-center justify-center text-center">
      <div className="space-y-6">
        ...
        <div className="flex gap-4 justify-center">
          <Link to="/products/men" className="border-2 border-white text-white px-6 py-2 hover:bg-white hover:text-black transition inline-block">
            Shop Men's Collection
          </Link>
          <Link to="/products/women" className="border-2 border-white text-white px-6 py-2 hover:bg-white hover:text-black transition inline-block">
